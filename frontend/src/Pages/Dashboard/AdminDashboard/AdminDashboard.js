        ...
        <div className="dashboard">
            <div className="dashboard-card">
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <p className={`dashboard-option ${active === "profile" ? "clicked" : ""}`}
                    ...
                    <p className={`dashboard-option ${active === "report" ? "clicked" : ""}`}
                        onClick={() => { setActive("report"); setSidebar(false) }}>
                        <AssessmentIcon className='dashboard-option-icon' /> Reports
                    </p>
                ...
                <div className="dashboard-option-content">
                    ...
                    <div style={active !== "addbook" ? { display: 'none' } : {}}>
                        <AddBook />
                    </div>

                    <div style={active !== "addtransaction" ? { display: 'none' } : {}}>
                        <AddTransaction />
                    </div>

                    <div style={active !== "addmember" ? { display: 'none' } : {}}>
                        <AddMember />
                    </div>

                    <div style={active !== "getmember" ? { display: 'none' } : {}}>
                        <GetMember />
                    </div>

                    <div style={active !== "returntransaction" ? { display: 'none' } : {}}>
                        <Return />
                    </div>

                    <div style={active !== "report" ? { display: 'none' } : {}}>
                        <ReportDashboard />
                    </div>
